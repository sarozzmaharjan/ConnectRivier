			...
			<div id="wholesite">
				...
				<div id="pagebody">
						...
						<div id="settings_left">
							...
							<div class="sidenav">
								<a href="/ConnectRivier/connectrivier/personalInformation.jsp">Personal Information</a>
								<a href="/ConnectRivier/connectrivier/changePassword.jsp" class="">Change Password</a>															
								<a href="/ConnectRivier/connectrivier/delAccount.jsp" class="">Delete Account</a>

								
							</div>	
						</div>
						<div id="settings_right">
						<div class="ttl"><div class="ttl2"><h3>Change Your Password</h3></div></div>
							<html:form action="/changePasswordAction.do" method="post">
								<table id="setform" cellspacing="5">
									<tr>
										...
										<td><html:password name="changepassword" property="oldpassword" value="" /></td>
									</tr>
									<tr>
										<td class="setparam"><bean:message key="lbl.newPassword" /></td>
										<td><html:password name="changepassword" property="newpassword" value=""  /></td>
									</tr>
									<tr>
										<td class="setparam"><bean:message key="lbl.confirmPassword" /></td>
										<td><html:password name="changepassword" property="confirmpassword" value=""  /></td>
									</tr>
									<tr>
									    <td></td>
										<td><html:submit  value="Change Password"  style="padding:4px; font-weight:bold;"/></td>
										<td><html:reset /></td>
									</tr>
								</table>
							</html:form>
