...
margin-top:-80px;
	...
	<div id="toprow" class="">
					<div id="toprow2">
							...
							<div id="userlinks">
								<a href="http://sand.truman.edu/~sm5314/capstone/signin"><b>Sign in</b></a>
								<a href="http://sand.truman.edu/~sm5314/capstone/signup"><b>Sign up</b></a>
							</div>
	...
	<div id="nethdr1">
		<div id="nethdr2">
			...
			<div id="netnav" class="specialhomelink">
							<a href="http://sand.truman.edu/~sm5314/capstone/dashboard" id="logolink" title="ConnectRivier">ConnectRivier</a>																													
			</div>
			 ...
			 <logic:present name="errorList">
						...
						<table id="regform" cellspacing="5">
							<tr>
								...
								<td><input type="text" name="email" value="" maxlength="100" class="reginp" /></td>
							</tr>
							<tr>
								<td></td>
